jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    }), jQuery.extend(jQuery.easing, { easeInOutMaterial: function(a, b, c, d, e) { return (b /= e / 2) < 1 ? d / 2 * b * b + c : d / 4 * ((b -= 2) * b * b + 2) + c } }), ! function(a) {
        function b(a) {
            var b = a.length,
                d = c.type(a);
...
Vel = $ ? $.Velocity : Velocity,
        ...
        a.fn.scrollTo = function(b) { return a(this).scrollTop(a(this).scrollTop() - a(this).offset().top + a(b).offset().top), this }, a.fn.dropdown = function(b) {
            ...
            this.each(function() {
                ...
                function e() {
                    ...
                    i.css({ position: "absolute", top: g.position().top + b, left: leftPosition }), i.stop(!0, !0).css("opacity", 0).slideDown({ queue: !1, duration: h.inDuration, easing: "easeOutCubic", complete: function() { a(this).css("height", "") } }).animate({ opacity: 1 }, { queue: !1, duration: h.inDuration, easing: "easeOutSine" })
                }

                function f() { i.fadeOut(h.outDuration), i.removeClass("active"), g.removeClass("active") }
                var g = a(this),
                    h = a.extend({}, c, b),
                    i = a("#" + g.attr("data-activates"));
                if (d(), g.after(i), h.hover) {
                    var j = !1;
                    g.unbind("click." + g.attr("id")), g.on("mouseenter", function(a) { j === !1 && (e(), j = !0) }), g.on("mouseleave", function(b) {
                ...
                } else g.unbind("click." + g.attr("id")), g.bind("click." + g.attr("id"), function(b) { g[0] != b.currentTarget || g.hasClass("active") || 0 !== a(b.target).closest(".dropdown-content").length ? g.hasClass("active") && (f(), a(document).unbind("click." + i.attr("id"))) : (b.preventDefault(), e()), i.hasClass("active") && a(document).bind("click." + i.attr("id"), function(b) { i.is(b.target) || g.is(b.target) || g.find(b.target).length || (f(), a(document).unbind("click." + i.attr("id"))) }) });
            ...
            return this.each(function() {
                ...
                if (!a(this).hasClass("initialized")) {
                    ...
                    i.wrap(j), i.on("click", function() {
                        ...
                        if (f === !1) return b(), !1;
                        if (e && f === !0) return b(), !1;
                        for (f = !1, i.addClass("active"), e = !0, h.css({ width: h[0].getBoundingClientRect().width, height: h[0].getBoundingClientRect().height, position: "relative", top: 0, left: 0 }), c = void 0, d = h[0].parentNode; null !== d && !a(d).is(document);) { var n = a(d); "hidden" === n.css("overflow") && (n.css("overflow", "visible"), c = void 0 === c ? n : c.add(n)), d = d.parentNode }
    ...
    function(a) {
        a.fn.tooltip = function(c) {
            ...
            return "remove" === c ? (this.each(function() { a("#" + a(this).attr("data-tooltip-id")).remove() }), !1) : (c = a.extend(h, c), this.each(function() {
                ...
                l.appendTo(k), l.css({ top: 0, left: 0 }), i.off("mouseenter.tooltip mouseleave.tooltip"), i.on({
                    "mouseenter.tooltip": function(a) {
                        var h = i.data("delay");
                        h = void 0 === h || "" === h ? c.delay : h, d = 0, f = setInterval(function() {
                            if (d += 10, d >= h && e === !1) {
                                e = !0, k.css({ display: "block", left: "0px", top: "0px" }), k.children("span").text(i.attr("data-tooltip"));
    ...
    function(a) {
        ...
        function f(a) {
            ...
            for (var b = null, c = a.target || a.srcElement; null !== c.parentElement;) {
                if (!(c instanceof SVGElement || -1 === c.className.indexOf("waves-effect"))) { b = c; break }
    ...
    function(a) {
        a(document).ready(function() {
            ...
            function c(a, b, c) { var e = a.indexOf(b); - 1 === e ? a.push(b) : a.splice(e, 1), c.siblings("ul.dropdown-content").find("li").eq(b).toggleClass("active"), c.find("option").eq(b).prop("selected", !0), d(a, c) }
            ...
            a(this).each(function() {
                ...
                if (!d.hasClass("browser-default")) {
                    ...
                    var i, j = a('<ul id="select-options-' + g + '" class="dropdown-content select-dropdown ' + (e ? "multiple-select-dropdown" : "") + '"></ul>'),
                        ...
                        l = [],
                        m = !1;
                    i = void 0 !== d.find("option:selected") ? d.find("option:selected") : j.first(), k.each(function() { e ? j.append(a('<li class="' + (a(this).is(":disabled") ? "disabled" : "") + '"><span><input type="checkbox"' + (a(this).is(":disabled") ? "disabled" : "") + "/><label></label>" + a(this).html() + "</span></li>")) : j.append(a('<li class="' + (a(this).is(":disabled") ? "disabled" : "") + '"><span>' + a(this).html() + "</span></li>")) }), j.find("li").each(function(f) {
                        var g = d;
                        a(this).click(function(d) { a(this).hasClass("disabled") || (e ? (a('input[type="checkbox"]', this).prop("checked", function(a, b) { return !b }), c(l, a(this).index(), g), p.trigger("focus")) : (j.find("li").removeClass("active"), a(this).toggleClass("active"), g.siblings("input.select-dropdown").val(a(this).text())), activateOption(j, a(this)), g.find("option").eq(f).prop("selected", !0), g.trigger("change"), "undefined" != typeof b && b()), d.stopPropagation() })
                    }), d.wrap(h);
                        ...
                        r = function(b) {
                            ...
                            if (13 != b.which || j.is(":visible")) {
                                ...
                                if (c && -1 === d.indexOf(b.which)) {
                                    q.push(c);
                                    var f = q.join(""),
                                        g = j.find("li").filter(function() { return 0 === a(this).text().toLowerCase().indexOf(f) })[0];
                                ...
                                40 == b.which && (g = j.find("li.selected").length ? j.find("li.selected").next("li:not(.disabled)")[0] : j.find("li:not(.disabled)")[0], activateOption(j, g)), 27 == b.which && p.trigger("close"), 38 == b.which && (g = j.find("li.selected").prev("li:not(.disabled)")[0], g && activateOption(j, g)), setTimeout(function() { q = [] }, 1e3)
                            }
                        };
                    p.on("keydown", r)
                }
        ...
        var b = {
            init: function(b) {
                ...
                return b = a.extend(c, b), this.each(function() {
                    ...
                    if (-1 != i && (e = h.eq(i)), f.hasClass("fullscreen") || (b.indicators ? f.height(b.height + 40) : f.height(b.height), g.height(b.height)), h.find(".caption").each(function() { c(a(this), 0) }), h.find("img").each(function() { a(this).css("background-image", "url(" + a(this).attr("src") + ")"), a(this).attr("src", "data:image/gif;base64,R0lGODlhAQABAIABAP///wAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==") }), b.indicators) {
                    ...
                    f.hammer({ prevent_default: !1 }).bind("pan", function(a) {
                        if ("touch" === a.gesture.pointerType) {
                            ...
                            $curr_slide = g.find(".active"),
                                $curr_slide.velocity({ translateX: c }, { duration: 50, queue: !1, easing: "easeOutQuad" }), 4 === b && (c > f.innerWidth() / 2 || -.65 > d) ? m = !0 : 2 === b && (c < -1 * f.innerWidth() / 2 || d > .65) && (l = !0);
                            var e;
    ...
    function(a) {
        ...
        var b = function(b) {
            ...
            c = function(a) {
                ...
                d === !0 ? c = 40 : b = 40, $this.removeClass("active"), $this.find("ul .btn-floating").velocity("stop", !0), $this.find("ul .btn-floating").velocity({ opacity: "0", scaleX: ".4", scaleY: ".4", translateY: b + "px", translateX: c + "px" }, { duration: 80 })
            }
    }(jQuery),
    function(a) {
        Materialize.fadeInImage = function(b) {
            ...
            var c = 0;
            a(b).find("li").velocity({ translateX: "-100px" }, { duration: 0 }), a(b).find("li").each(function() { a(this).velocity({ opacity: "1", translateX: "0" }, { duration: 800, delay: c, easing: [60, 10] }), c += 120 })
        }, a(document).ready(function() {
            var b = !1,
                c = !1;
    ...
    function(a) { "function" == typeof define && define.amd ? define(["picker", "jquery"], a) : "object" == typeof exports ? module.exports = a(require("./picker.js"), require("jquery")) : a(Picker, jQuery) }(function(a, b) {
        ...
        c.prototype.set = function(a, b, c) {
            ...
            return "flip" == c ? d.flipEnable() : c === !0 ? (d.flipEnable(1), e = []) : c === !1 ? (d.flipEnable(-1), e = []) : c.map(function(a) {
                var c, h, i, j;
                for (i = 0; g > i; i += 1) { if (h = e[i], d.isDateExact(h, a)) { c = e[i] = null, j = !0; break } if (d.isDateOverlap(h, a)) { b.isPlainObject(a) ? (a.inverted = !0, c = a) : b.isArray(a) ? (c = a, c[3] || c.push("inverted")) : f.isDate(a) && (c = [a.getFullYear(), a.getMonth(), a.getDate(), "inverted"]); break } }
                if (c)
                    for (i = 0; g > i; i += 1)
