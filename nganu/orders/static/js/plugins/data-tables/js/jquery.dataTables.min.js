...
(function(Ea, P, k) {
    var O = function(h) {
        ...
        function Ha(a) {
            ...
            for (f = b.length; d < f; d++)
                if (l = b[d], o = [], !l.sType && l._sManualType) l.sType = l._sManualType;
                        ...
                        q = e[g](o[j], a); if (!q && g !== e.length - 1) break; if ("html" === q) break } if (q) { l.sType = q; break } }
            ...
            for (var f = a.sDom.split(""), g, i, j, n, l, q, o = 0; o < f.length; o++) {
                ...
                if ("<" == i) { j = h("<div/>")[0];
                    ...
                    q = 0; for (n = j.length; q < n; q++)
                        if (i == j[q].cFeature) { g = j[q].fnInit(a); break } }
        ...
        function xa(a) { var b = a.aLastSort,
                ...
                d = 0; for (f = e.length; d < f; d++) g = e[d].src, h(D(a.aoData, "anCells", g)).addClass(c + (2 > d ? d + 1 : 3)) }
            a.aLastSort = e }
        ...
        m = function(a) {
            ...
            this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) R(null, 0, "Non-table node initialisation (" +
                    ...
                    if (d.aaSorting ===
                        k) { o = p.aaSorting;
                        g = 0; for (i = o.length; g < i; g++) o[g][1] = p.aoColumns[g].asSorting[0] }
                    xa(p);
            ...
            pageButton: {
                _: function(a, b, c, e, d, f) {
                    var g = a.oClasses,
                        ...
                        o;
                    try { o = h(P.activeElement).data("dt-idx") } catch (r) {}
                    m(h(b).empty(), e);
